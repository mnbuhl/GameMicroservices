...
import { LoginActions, QueryParameterNames, AuthorizationPaths } from '../constants/ApiAuthorizationConstants';
...
export class Login extends Component {
  ...
  redirectToRegister() {
    this.redirectToApiAuthorizationPath(
      ...
      `${AuthorizationPaths.IdentityRegisterPath}?${QueryParameterNames.ReturnUrl}=${encodeURI(AuthorizationPaths.Login)}`
    );
  }
