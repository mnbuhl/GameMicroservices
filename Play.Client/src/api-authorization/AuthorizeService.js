...
import { ApplicationName, AuthorizationPaths } from '../constants/ApiAuthorizationConstants';
...
export class AuthorizeService {
  ...
  async ensureUserManagerInitialized() {
    ...
    let settings = {
      ...
      response_type: 'code',
      scope: 'openid profile catalog.full-access inventory.full-access IdentityServerApi roles',
